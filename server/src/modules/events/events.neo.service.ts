...
export class EventsNeoService implements IEventsNeoService {
  ...
  async addGenreById(currentEvent: Event, genreToAdd: Genre): Promise<Event> {
    ...
    return await this.eventsNeoRepository.createRelationship(
      currentEventId,
      genreToAddId,
      'Genre',
    );
  ...
  async addGenreByName(currentEvent: Event, genreToAdd: Genre): Promise<Event> {
    ...
    return await this.eventsNeoRepository.createRelationshipWithQuery(
      currentEventId,
      { name },
      'Genre',
    );
  ...
  async removeGenreById(
    ...
    return await this.eventsNeoRepository.deleteRelationship(
      currentEventId,
      genreToRemoveId,
      'Genre',
    );
  ...
  async removeGenreByName(
    ...
    return await this.eventsNeoRepository.deleteRelationshipWithQuery(
      currentEventId,
      { name },
      'Genre',
    );
  ...
  async findEventWithGenres(event: Event): Promise<Event> {
    const { id } = event;
    return await this.eventsNeoRepository.getRelationship(
      id,
      'Genre',
